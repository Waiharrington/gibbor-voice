...
export default function Sidebar({ currentView, onViewChange }: SidebarProps) {
    ...
    return (
        <>
            {/* Mobile Toggle */}
            <div className="xl:hidden fixed top-0 left-0 p-4 z-50">
                <button
            ...
            <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-50 border-r border-gray-200 h-screen flex flex-col transform transition-transform duration-200 ease-in-out xl:translate-x-0 xl:static ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
